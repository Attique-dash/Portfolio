        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter leading-[1.1]">
              Crafting <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">Digital</span> 
              <br /> Experiences
            </h1>

            <p className="mt-8 text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed font-light">
              I&apos;m <span className="text-white font-medium">Attique</span>, a Computer Science student at Superior University. 
              I specialize in bridging the gap between <span className="text-blue-400">AI Intelligence</span> and <span className="text-purple-400">Creative UI/UX</span> to build applications that actually matter.
            </p>
            ...
            >
              ...
              <Link
                href="/cv"
                className="group px-8 py-4 bg-white/5 border border-white/10 rounded-2xl font-bold backdrop-blur-md hover:bg-white/10 transition-all flex items-center gap-2 active:scale-95"
              >
          ...
          <motion.div 
            ...
            className="w-full md:w-2/5 relative flex justify-center items-center"
          >
            {/* Animated Ring behind image */}
            <div className="absolute w-[300px] h-[300px] md:w-[450px] md:h-[450px] border border-blue-500/20 rounded-full animate-[spin_10s_linear_infinite]" />
